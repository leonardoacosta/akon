...
export const AddToVolunteers = () => {
	...
	const { refetch } = trpc.users.all.useQuery({ department: 'isVolunteers' });
	...
	const initialValues = {
		email: '',
		phoneNumber: '',
		department: 'isVolunteers' as Departments
	};
	...
	return (
		<Modal
			...
			modalDescription='This volunteer will be added to the general volunteer department, they will not get access to this screen'
			open={open}
			setOpen={setOpen}
		>
			<Formik
...
export default AddToVolunteers;
